...
namespace JIoffe.BIAD.QnABot
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Step X) Retrieve the service from botConfig that is of type QnA; 
            ...
            //Step X) Create a new instance of QnAMaker and add it to the services container as a singleton
            ...
            services.AddBot<QnAMakerBot>(options =>
            {
                ...
                //Step x) Add a callback for "OnTurnError" that logs any bot or middleware errors to the console
